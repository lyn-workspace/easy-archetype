...
/**
 * xss clean 参考自 jpress：https://gitee.com/fuhai/jpress
 *
 * @author luyanan
 * @since 2021/2/8
 **/
public class XssUtil {
	...
	public static class HtmlWhitelist extends org.jsoup.safety.Whitelist {
		...
		public final static String DATABASE64 = "data:;base64";
		...
		protected boolean isSafeAttribute(String tagName, Element el, Attribute attr) {
			...
			// 允许 base64 的图片内容
			if (IMG.equals(tagName) && SRC.equals(attr.getKey()) && attr.getValue().startsWith(DATABASE64)) {
				return true;
			}
