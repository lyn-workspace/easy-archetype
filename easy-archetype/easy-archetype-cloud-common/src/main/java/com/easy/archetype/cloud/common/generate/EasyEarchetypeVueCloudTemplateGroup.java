 ...
 * @since 2021/2/3
 **/
public class EasyEarchetypeVueCloudTemplateGroup extends AbstractTemplateGroup {
	...
	public EasyEarchetypeVueCloudTemplateGroup(boolean swagger, boolean mybatisPlus) {
