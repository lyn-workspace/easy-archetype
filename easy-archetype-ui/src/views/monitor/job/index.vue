        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="调用类型" prop="invokeType">
              <el-select v-model="form.invokeType" placeholder="请选择">
                <el-option
                  v-for="type in invokeTypeOptions"
                  :key="type"
                  :label="type"
                  :value="type"
                ></el-option>
          ...
          <el-col :span="24">
            <el-form-item prop="invokeTarget">
              ...
              <el-input v-model="form.invokeTarget" type="textarea" placeholder="请输入调用目标字符串"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                     <el-link type="success" target="_blank" href="http://cron.qqe2.com/">在线cron</el-link>
                  </div>
                  <i class="el-icon-question"></i>
                </el-tooltip>
              </span>
...
export default {
  ...
  methods: {
    ...
    invokeTypes() {
      invokeTypes().then(response => {
        this.invokeTypeOptions = response.data
      })
    },
