 ...
 * @since 2021/1/23
 **/
@ConditionalOnProperty(prefix = EasyArchetypeFrameworkProperties.PREFIX, name = "spring.enable", havingValue = "true", matchIfMissing = true)
@Component
@Slf4j
@Lazy(false)
public class SpringContextHolder extends org.springframework.web.util.WebUtils implements ApplicationContextAware, DisposableBean {
