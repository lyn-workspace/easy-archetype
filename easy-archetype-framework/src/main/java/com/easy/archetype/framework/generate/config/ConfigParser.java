...
public class ConfigParser {
    ...
    public Map<String, String> parser(String configPath) {
        ...
        cc.setConversionHandler(new ConversionHandler() {
            ...
            @Override
            public <T> void toCollection(Object o, Class<T> aClass, ConfigurationInterpolator configurationInterpolator, Collection<T> collection) {
            }
        });
    ...
    private <T> boolean isBoolean(T value) {
        return value != null &&
                (value instanceof String && StrUtil.isNotBlank(value.toString()))
