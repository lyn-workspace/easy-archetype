...
public class GlobalConfig extends HashMap<String, Object> {
    ...
    public String[] getIncludes() {
        return Arrays
                .stream(this.getOrDefault(GlobalConfigKey.INCLUDES, "").toString().split(","))
    ...
    public String[] getExclude() {
        return Arrays
                .stream(this.getOrDefault(GlobalConfigKey.EXCLUDE, "").toString().split(","))
                .filter(a -> StrUtil.isNotBlank(a))
                .toArray(String[]::new);
    }
    ...
    public String[] getRemoveTablePrefix() {
        ...
        return Arrays
                .stream(this.getOrDefault(GlobalConfigKey.REMOVE_TABLE_PREFIX, "").toString().split(","))
                .filter(a -> StrUtil.isNotBlank(a))
                .toArray(String[]::new);
    }
