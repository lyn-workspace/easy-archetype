...
public class SimpleDocTemplateGroup extends AbstractTemplateGroup {
    ...
    public List<OutputFile> generate(List<TableInfoEntity> tableInfoEntities, ITemplateEngine templateEngine, GlobalConfig globalConfig) {
        ...
        TemplateBuilder templateBuilder = TemplateBuilder.builder().tableInfoEntity(new TableInfoEntity()).globalConfig(globalConfig);
...
//            defaultInitData(data, globalConfig);
    ...
    @Override
    public List<TableInfoEntity> getGenerateTableInfo(ITableQueryResult tableQueryResult,
                                                      GlobalConfig globalConfig, IColumnTypeConver columnTypeConver) {
