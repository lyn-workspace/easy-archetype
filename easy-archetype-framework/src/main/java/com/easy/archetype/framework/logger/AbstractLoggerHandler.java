...
public abstract class AbstractLoggerHandler implements LoggerHandler {
    ...
    public void handler(LoggerVo loggerVo) {
        // 忽略注解
        Method method =
                loggerVo.getMethodSignature().getMethod();
        ...
        // 参数
        loggerData.put("params",
                null == loggerVo.getArgs() ? null : JSON.toJSONString(getRequestParams(loggerVo.getMethodSignature(), loggerVo.getArgs())));
        //  方法介绍
