...
public interface ITemplateGroup {
     ...
     * @since 2021/2/1
     */
    List<OutputFile> generate(List<TableInfoEntity> tableInfoEntities, ITemplateEngine templateEngine, GlobalConfig globalConfig);
     ...
     * @since 2021/2/1
     */
    List<TableInfoEntity> getGenerateTableInfo(ITableQueryResult tableQueryResult
