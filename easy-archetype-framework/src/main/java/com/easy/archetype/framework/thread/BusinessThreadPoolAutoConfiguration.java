 ...
 **/
@Configuration
@ConditionalOnProperty(prefix = EasyArchetypeFrameworkProperties.PREFIX, name = "thread.enable", havingValue = "true", matchIfMissing = true)
@Slf4j
@EnableAsync
...
public class BusinessThreadPoolAutoConfiguration implements AsyncConfigurer {
    ...
    public BusinessThreadPoolTaskExecutor businessThreadPoolTaskExecutor(ObjectProvider<BusinessThreadInterceptor> businessThreadInterceptors, BusinessThreadPoolProperties asyncThreadPoolProperties) {
        ...
        //线程池最大线程数,默认：40000
        taskExecutor.setMaxPoolSize(Objects.nonNull(asyncThreadPoolProperties.getMaxPoolSize()) ? asyncThreadPoolProperties.getMaxPoolSize() : 4000);
        //线程队列最大线程数,默认：80000
        ...
        //线程名称前缀
        taskExecutor.setThreadNamePrefix(StringUtils.isNotBlank(asyncThreadPoolProperties.getThreadNamePrefix()) ? asyncThreadPoolProperties.getThreadNamePrefix() : "Business-ThreadPool-");
